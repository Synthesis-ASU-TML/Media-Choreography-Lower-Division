...
, 			{
				"box" : 				{
					...
					"text" : "loadmess title \"Contours 2\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 497.0, 142.0, 22.0 ],
					"text" : "servername contours-out"
				}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 77.0, 92.0, 150.0, 87.0 ],
													"presentation" : 1,
													"presentation_linecount" : 2,
													"presentation_rect" : [ 8.0, 33.0, 339.0, 33.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 359.0, 259.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 359.0, 224.0, 29.5, 22.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 359.0, 195.0, 98.0, 22.0 ],
													"text" : "zmap 0. 1. 0 100"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 221.5, 160.0, 117.0, 22.0 ],
													"text" : "o.route /contours/vol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 359.0, 160.0, 107.0, 22.0 ],
													"text" : "route /contours/vol"
												}
...
, 											{
												"box" : 												{
													...
													"presentation" : 1,
													"presentation_rect" : [ 202.0, 10.0, 145.0, 20.0 ],
													"text" : "Reset",
													"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ]
												}
...
, 			{
				...
				"patcherrelativepath" : "../../Application Projects/Contours/media",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
