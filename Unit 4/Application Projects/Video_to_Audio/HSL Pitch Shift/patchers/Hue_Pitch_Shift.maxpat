...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 276.0, 137.4453125, 26.0107421875, 28.109375 ],
					"presentation" : 1,
					"presentation_rect" : [ 277.0, 137.4453125, 26.0107421875, 28.109375 ],
					"rounded" : 100.0,
					"text" : "4",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 137.5, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 133.0, 264.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 155.0, 264.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 117.0, 248.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "checkitem 5 5 0, checkitem 5 6 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "checkitem 5 5 1, checkitem 5 6 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 248.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 274.0, 264.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.5, 421.0, 78.0, 22.0 ],
					"text" : "selector~ 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 13.5, 421.0, 78.0, 22.0 ],
					"text" : "selector~ 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 106.0, 633.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 609.0, 62.0, 22.0 ],
					"text" : "r to-ezdac"
				}
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						"allwindowsactive" : 0,
						"appicon_mac" : "Seagate Backup Plus Drive:/Synthesis/Media_Choreography_Course/Media Choreography Lower-Division/Unit 4/Application Projects/Video -> Audio/Hue Pitch Shift/other/hue_pitch_shift_icon.icns",
						"appicon_win" : "",
						"audiosupport" : 1,
						"bundleidentifier" : "org.asu.ame.synthesis.huepitchshift",
						...
						"overdrive" : 0,
						"preffilename" : "Hue Pitch Shift Preferences",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 324.0, 232.0, 271.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.5, 508.0, 81.0, 22.0 ],
					"text" : "loadmess -70"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 603.0, 175.0, 153.0, 328.0 ],
					"presentation" : 1,
					"presentation_linecount" : 14,
					"presentation_rect" : [ 324.0, 36.5, 272.0, 194.0 ],
					"text" : "The \"Hue Pitch Shift\" application uses the average hue of the input video stream to shift the pitch of the audio up to 2 octaves up or down from the original point. \n\nTo inspect how your input video is being analyzed, set the Video Preview Mode to \"HSL Preview\". The more red any given pixel has in that preview, the higher its hue value is. Pixels that fall are close to red, yellow, orange, pink, or white have high hue values and will contribute to a rise in pitch. Pixels that are green, blue, cyan, or black have a low hue value and will contribute to a drop in pitch."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 324.0, 6.5, 271.0, 27.0 ],
					"text" : "Hue Pitch Shift"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.5, 711.4453125, 26.0107421875, 28.109375 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 11.0, 560.0, 26.0107421875, 28.109375 ],
					"presentation" : 1,
					"presentation_rect" : [ 277.0, 204.4453125, 26.0107421875, 28.109375 ],
					"rounded" : 100.0,
					"text" : "5",
					"textoncolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 560.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 177.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.5, 709.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 277.0, 96.4453125, 26.0107421875, 28.109375 ],
					"rounded" : 100.0,
					"text" : "3",
					"textoncolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 78.5, 264.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 100.5, 264.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 46.5, 703.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 45.0, 553.0, 123.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 199.0, 264.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 85.5, 285.0, 151.5, 285.0 ],
					"source" : [ "obj-9", 1 ]
				}
