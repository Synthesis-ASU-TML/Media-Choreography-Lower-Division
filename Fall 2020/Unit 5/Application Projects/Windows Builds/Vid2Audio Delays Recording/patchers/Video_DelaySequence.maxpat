		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"appicon_win" : "",
						"audiosupport" : 1,
						"bundleidentifier" : "org.asu.ame.synthesis.videodelaysequence",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 279.0, 823.0, 141.408203125, 21.40625 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 279.0, 852.0, 172.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 276.0, 150.0, 26.0107421875, 28.109375 ],
					"rounded" : 100.0,
					"text" : "4",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 29.0, 843.4453125, 26.0107421875, 28.109375 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.5625, 778.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.5, 841.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 61.0, 778.0, 136.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 150.0, 264.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 342.0, 166.0, 271.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 706.0, 45.5, 271.0, 127.0 ],
					"presentation" : 1,
					"presentation_linecount" : 9,
					"presentation_rect" : [ 342.0, 39.5, 271.0, 127.0 ],
					"text" : "The \"Video Delay Sequence\" patch downsamples an input video stream into 10 stripes, these 10 stripes are then converted to the Hue-Saturation-Luminance colorspace. The hue of each stripe determines how much additional delay will be added to each sequential audio buffer. The luminance (or brightness) of each stripe determines the amount of pitch shifting applied to each audio buffer (±2 octaves)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 706.0, 20.0, 271.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 342.0, 14.0, 271.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 101.0, 203.0, 180.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 835.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.0, 532.0, 91.0, 22.0 ],
					"text" : "prepend delays"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.0, 500.0, 137.0, 22.0 ],
					"text" : "vexpr ($f1 / 255.) * 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 593.0, 473.0, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 706.0, 436.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 706.0, 404.0, 178.0, 22.0 ],
					"text" : "vexpr ($f1 / 255.) * 4800 - 2400."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 706.0, 377.0, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 60.5, 264.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 715.5, 461.0, 572.0, 461.0, 572.0, 221.0, 92.0, 221.0, 92.0, 227.0, 70.5, 227.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 602.5, 555.0, 573.0, 555.0, 573.0, 183.0, 132.0, 183.0, 132.0, 219.0, 90.0, 219.0, 90.0, 228.0, 70.5, 228.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-34" : [ "mc.live.gain~", "Audio Output Level", 0 ],
			"parameterbanks" : 			{
