...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 658.0, 83.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 597.0, 77.0, 22.0 ],
					"text" : "prepend rate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 44.0, 185.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 317.0, 45.0, 239.0, 22.0 ],
					"text" : "Playback Rate",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.75, 481.0, 29.5, 22.0 ],
					"text" : "1.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 481.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 481.0, 29.5, 22.0 ],
					"text" : "0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 481.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.5, 481.0, 29.5, 22.0 ],
					"text" : "-1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 195.0, 440.0, 74.0, 22.0 ],
					"text" : "sel 0 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 195.0, 388.0, 181.0, 44.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 315.0, 69.0, 243.0, 95.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Rewind", "Pause", "Slow-Mo", "Normal", "Fast-Forward" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.5, 618.0, 167.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 289.5, 184.0, 276.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.5, 580.0, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.5, 520.0, 276.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 289.5, 171.0, 276.0, 48.0 ],
					"setminmax" : [ -2.0, 2.0 ],
					"slidercolor" : [ 0.219607843137255, 0.098039215686275, 0.682352941176471, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 110.40625, 241.0, 21.40625 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 5.0, 185.0, 38.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 8.125, 566.0, 22.0 ],
					"text" : "Movie File Variable Speed Input"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 136.0, 239.0, 22.0 ],
					"text" : "Looping Mode"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 160.0, 243.0, 59.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 2.125, 577.0, 32.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 1.0, 577.0, 230.0 ],
					"proportion" : 0.5
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-37" : [ "live.tab[1]", "live.tab[1]", 0 ],
			"parameterbanks" : 			{
