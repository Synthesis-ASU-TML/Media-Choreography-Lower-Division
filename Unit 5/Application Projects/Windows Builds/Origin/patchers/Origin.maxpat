...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 335.0, 84.0, 22.0 ],
					"text" : "loadmess -70."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 710.0, 427.0, 84.0, 22.0 ],
					"text" : "loadmess -70."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 704.0, 84.0, 22.0 ],
					"text" : "loadmess -70."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 508.0, 427.0, 84.0, 22.0 ],
					"text" : "loadmess -70."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 351.0, 934.0, 55.25, 55.25 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 877.0, 307.0, 67.0, 22.0 ],
					"text" : "opendialog"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 745.0, 307.0, 67.0, 22.0 ],
					"text" : "opendialog"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 877.0, 335.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 745.0, 335.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 745.0, 363.0, 67.0, 22.0 ],
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_mmax" : 20.0,
							"parameter_mmin" : -70.0,
							"parameter_shortname" : "Movie File Level",
							"parameter_type" : 0,
							"parameter_unitstyle" : 4
						}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_mmax" : 6.0,
							"parameter_mmin" : -70.0,
							"parameter_shortname" : "Master Audio Level",
							"parameter_type" : 0,
							"parameter_unitstyle" : 4
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1055.0, 145.0, 48.0, 22.0 ],
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 431.921875, 399.0, 29.5, 22.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 384.0, 399.0, 44.0, 22.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 587.0, 317.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
,
					"patching_rect" : [ 687.0, 129.0, 172.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_mmax" : 20.0,
							"parameter_mmin" : -70.0,
							"parameter_shortname" : "Microphone Level",
							"parameter_type" : 0,
							"parameter_unitstyle" : 4
						}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 123.5, 462.0, 201.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.0, 140.0, 77.0, 22.0 ],
					"text" : "prepend rate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.0, 85.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 124.921875, 129.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 124.921875, 101.0, 29.5, 22.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 76.0, 79.0, 22.0 ],
					"text" : "prepend loop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 3.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 811.0, 31.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 811.0, 34.0, 22.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 782.0, 97.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 687.0, 38.0, 257.0, 22.0 ],
					"text" : "jit.world \"Origin Preview\" @erase_color 0 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 307.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 19.0, 374.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.833333333333329, 421.0, 62.0, 22.0 ],
					"text" : "switch 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 645.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 486.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 19.0, 715.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 145.0, 869.0, 158.0, 22.0 ],
					"text" : "jit.vcr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 262.0, 742.0, 78.0, 22.0 ],
					"text" : "selector~ 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 19.0, 558.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 321.166666666666686, 680.0, 78.0, 22.0 ],
					"text" : "selector~ 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 145.0, 667.0, 78.0, 22.0 ],
					"text" : "selector~ 3 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 456.0, 115.0, 67.0, 22.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "front" ],
									"patching_rect" : [ 456.0, 83.0, 39.0, 22.0 ],
									"text" : "t front"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 50.0, 100.0, 229.0, 221.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 1.0, 229.0, 221.0 ],
...
,
					"patching_rect" : [ 443.0, 229.0, 112.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 173.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 384.0, 455.0, 253.0, 22.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1055.0, 174.0, 92.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 728.0, 453.0, 136.0, 22.0 ],
					"text" : "adc~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 154.0, 229.0, 60.0, 22.0 ],
					"text" : "jit.movie~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 722.0, 267.0, 294.0, 131.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 334.5, 135.0, 312.0, 135.0, 312.0, 84.0, 513.0, 84.0, 513.0, 72.0, 537.5, 72.0 ],
					"order" : 0,
					"source" : [ "obj-58", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 537.5, 132.0, 525.0, 132.0, 525.0, 96.0, 334.5, 96.0 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 596.5, 364.0, 584.0, 364.0, 584.0, 328.0, 393.5, 328.0 ],
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 393.5, 367.0, 371.0, 367.0, 371.0, 316.0, 572.0, 316.0, 572.0, 304.0, 596.5, 304.0 ],
					"order" : 0,
					"source" : [ "obj-72", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-110" : [ "live.gain~[4]", "Preview Audio Level", 0 ],
			"obj-13" : [ "live.tab[1]", "live.tab[1]", 0 ],
			"obj-32" : [ "live.tab[2]", "live.tab[1]", 0 ],
			"obj-49" : [ "live.tab[3]", "live.tab", 0 ],
			"obj-66" : [ "live.gain~", "Audio File Level", 0 ],
			"obj-67" : [ "live.gain~[1]", "Microphone Level", 0 ],
			"obj-82" : [ "live.gain~[2]", "Master Audio Level", 0 ],
			"obj-96" : [ "live.gain~[3]", "Movie File Level", 0 ],
			"parameterbanks" : 			{
