...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 175.0, 45.0, 22.0 ],
					"text" : "r vgain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 814.0, 318.5, 67.0, 22.0 ],
					"text" : "delay 1500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 814.0, 290.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 828.5, 345.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 65.25, 201.0, 150.0, 20.0 ],
...
,
					"patching_rect" : [ 727.5, 371.0, 120.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 892.0, 596.0, 150.0, 33.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 779.0, 311.0, 276.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 892.0, 357.0, 161.0, 234.0 ],
									"presentation" : 1,
									"presentation_linecount" : 9,
									"presentation_rect" : [ 779.0, 182.0, 282.0, 127.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 878.0, 405.0, 66.0, 33.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 952.0, 150.0, 121.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 779.0, 144.0, 171.0, 32.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 0,
									"numoutlets" : 0,
									"patching_rect" : [ 617.0, 356.0, 256.000006437301636, 182.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 767.0, 106.0, 334.769239187240601, 238.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 792.0, 23.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 175.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 344.0, 24.5546875, 276.0, 27.0 ],
					"text" : "Contours"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 366.75, 199.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 347.5, 10.5, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.25, 7.5, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 436.25, 96.5, 88.0, 22.0 ],
					"text" : "dim 1920 1080"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.75, 96.5, 81.0, 22.0 ],
					"text" : "dim 1280 720"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 247.25, 62.5, 302.5, 22.0 ],
					"text" : "sel 0 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.25, 96.5, 75.0, 22.0 ],
					"text" : "dim 640 360"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 247.25, 35.5, 264.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 252.0, 71.0, 22.0 ],
					"text" : "prepend vol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 301.0, 216.5, 211.0, 30.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.75, 166.5, 255.0, 30.0 ],
					"size" : 100.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 15.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.75, 80.0, 255.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 49.0, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 50.0, 119.0, 70.0, 22.0 ],
					"text" : "jit.gl.texture"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 50.0, 82.0, 178.0, 22.0 ],
					"text" : "jit.movie @automatic 1 @loop 1"
				}
