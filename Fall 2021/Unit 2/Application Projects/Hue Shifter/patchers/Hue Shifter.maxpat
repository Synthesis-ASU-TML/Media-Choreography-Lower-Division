...
,
					"patching_rect" : [ 13.75, 260.0, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 748.0, 67.0, 22.0 ],
					"saved_object_attributes" : 					{
						"allwindowsactive" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 310.0, 268.0, 231.0, 33.0 ],
					"text" : "Connor Rawls, Synthesis, AME, ASU, June 2020"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 14.0, 494.0, 201.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-7::obj-22" : [ "live.tab[7]", "live.tab", 0 ],
			"obj-7::obj-27" : [ "live.tab[6]", "live.tab[2]", 0 ],
...
,
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../Hue Shifter/media",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
