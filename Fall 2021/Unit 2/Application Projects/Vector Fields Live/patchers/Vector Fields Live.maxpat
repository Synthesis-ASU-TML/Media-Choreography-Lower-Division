...
,
					"patching_rect" : [ 32.0, 456.0, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1606.0, 99.0, 203.0, 543.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-6::obj-22" : [ "live.tab[7]", "live.tab", 0 ],
			"obj-6::obj-27" : [ "live.tab[6]", "live.tab[2]", 0 ],
			"parameterbanks" : 			{
...
, 			{
				"name" : "vectors.json",
				"bootpath" : "/Volumes/Seagate Backup Plus Drive/Synthesis/Media_Choreography_Course/Media Choreography Lower-Division/Unit 2/Application Projects/Live Input/Vector Fields Live/data",
